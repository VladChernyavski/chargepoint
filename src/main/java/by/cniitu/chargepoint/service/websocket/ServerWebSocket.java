...
public class ServerWebSocket extends WebSocketServer {
    ...
    static Map<Integer, Set<WebSocket>> userWebSockets = new HashMap<>();

    // all charge points for map
    public static Map<Integer, MapPoint> chargePointsMap = new HashMap<>();

    static{
        chargePointsMap.put(31, new MapPoint(31, new Properties("заправка 1", "27.6416015625, 53.97183955821782", "00:00 - 24:00"),
    ...
    WebInformation webInformation = new WebInformation("data", new LinkedList<>(chargePointsMap.values()));
    ...
    public void onMessage(WebSocket webSocket, String s) {
        ...
        if(s.startsWith("{id:")){
            Integer userId = Integer.parseInt(s.substring(4, s.length() - 1));
